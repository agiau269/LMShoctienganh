...
def login_page():
    ...
    with left:
        ...
        st.markdown(
            '<div class="small-note">Đăng nhập vào tài khoản EnglishHub của bạn.</div>',
            unsafe_allow_html=True
        )
    ...
    with right:
        ...
        st.markdown(
            '<div class="section-title">Tạo tài khoản</div>',
            unsafe_allow_html=True
        )

        st.markdown(
            '<div class="small-note">Chọn đúng loại tài khoản để đăng ký.</div>',
            unsafe_allow_html=True
        )
...
def teacher_lessons():
    ...
    for lesson in lessons:
        ...
        with st.container(border=True):
            ...
            st.caption(
                f"{lesson['level']} | {lesson['category']}"
            )
            ...
            st.write(
                f"Học sinh đã xem: {lesson['viewed_count']}"
            )
...
def student_sidebar():
    ...
    with st.sidebar:
        ...
        st.caption(
            ...
            +
            str(
                st.session_state.user["class_code"]
            )
        )
